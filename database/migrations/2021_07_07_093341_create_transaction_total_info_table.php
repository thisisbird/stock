...
class CreateTransactionTotalInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_total_info', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('transaction_total_info');
    }
}
